...
# !!! Main.UserApp is configured as an alias for Main.Latexminimumexample and you might encounter it in some tests
using Main.Latexminimumexample, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Latexminimumexample tests" begin
  @includetests ARGS
end
